                    ...
                    <div class="col-sm-9 border-start border-success">
                        ...
                        <div class="row p-4">
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" class="mt-3">
                                <div class="mb-3">
                                    ...
                                    <select name="store_product_name" class="form-select">
                                        ...
                                        while ($productData = mysqli_fetch_array($productQuery)) {
                                            $product_id = $productData['prdouct_id'];
                                ...
                                <div class="mb-3">
                                    <label for="store_product_quantity" class="form-label">Product Quantity:</label>
                                    <input type="text" name="store_product_quantity" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label for="store_product_entry_date" class="form-label">Store Entry Date:</label>
                                    <input type="date" name="store_product_entry_date" class="form-control">
                                </div>
